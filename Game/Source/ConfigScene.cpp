...
bool ConfigScene::Start()
{
	...
	btnConfig = new GuiCheckBox(8, { (1280 / 2 - 300 / 2), 180, 40, 40 }, "FULLSCREEN", app->intro->fulled);
	...
	btnVsync = new GuiCheckBox(9, { (1280 / 2 - 300 / 2), 240, 40, 40 }, "VSYNC", app->intro->vsyncClicked);
